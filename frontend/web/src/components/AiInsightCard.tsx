  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs text-blue-400 ml-auto">Powered by Gemini</span>
      </div>
      ...
      {!answer && !loading && (
        <p className="text-sm text-blue-500 mb-4">Ask a question about your business to get AI insights.</p>
      )}
