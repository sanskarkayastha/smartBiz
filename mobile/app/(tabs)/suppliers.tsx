...
import {
  supplierService, Supplier, SupplierProduct, SupplierFilters,
...
export default function Suppliers() {
  ...
  const buildFilters = (): SupplierFilters | undefined => {
    ...
    if (hasBalance) f.hasBalance = true;
    return Object.keys(f).length ? f : undefined;
  };

  const load = useCallback(async () => {
    try {
      const data = await supplierService.getSuppliers(0, 20, buildFilters());
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyText}>
                {search || activeFilterCount > 0 ? 'Try adjusting your search or filters' : 'Add suppliers directly or via a product'}
              </Text>
            </View>
          }
          ListFooterComponent={
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalSheet, styles.filterSheet]}>
            ...
            <Pressable
              ...
              onPress={() => setPendingHasBalance((v) => !v)}
            >
              <View style={styles.toggleInfo}>
                <Text style={styles.toggleLabel}>Has Outstanding Balance</Text>
                <Text style={styles.toggleSub}>Only show suppliers you owe money to</Text>
              </View>
